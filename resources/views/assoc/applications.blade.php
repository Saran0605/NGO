        ...
        <form id="edit_farmer_form">
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="edit_spouse">
              <label>Mobile</label>
              <input type="text" class="form-control" id="edit_mobile">
              <label>Gender</label>
              <input type="text" class="form-control" id="edit_gender">
              <label>Identity Card</label>
              <input type="text" class="form-control" id="edit_id_type">
              <label>Household Members</label>
              <input type="number" class="form-control" id="edit_h_members">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="edit_toilet_avail">
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.status === 200) {
                ...
                $('#edit_spouse').val(farmer.spouse);
                $('#edit_mobile').val(farmer.mobile);
                $('#edit_gender').val(farmer.gender);
                $('#edit_id_type').val(farmer.id_type);
                $('#edit_h_members').val(farmer.h_members);
                $('#edit_id_number').val(farmer.id_number);
                ...
                $('#edit_toilet_avail').val(farmer.toilet_avail);
